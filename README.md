...
lotto/states/ny.py     New York scraper
lotto/states/__init__  registry; add new states here
...
then append the module to `ALL`. The metrics and the site need nothing else.
